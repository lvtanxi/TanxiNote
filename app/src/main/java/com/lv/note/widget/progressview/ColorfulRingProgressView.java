...
public class ColorfulRingProgressView extends View {
    ...
    public ColorfulRingProgressView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mTextColor = a.getColor(R.styleable.ColorfulRingProgressView_fgtextColor, mTextColor);
            mPercent = a.getFloat(R.styleable.ColorfulRingProgressView_percent, 0);
            mTextSzie = a.getInt(R.styleable.ColorfulRingProgressView_fgtextSzie, mTextSzie);
    ...
    private void init() {
        ...
        mTextPaint.setAlpha(0x0000ff);
        mTextPaint.setColor(mTextColor);
        mTextPaint.setTextSize(dp2px(mTextSzie));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(mPercent + "%", getWidth() / 2, getHeight() / 2, mTextPaint);
    }
